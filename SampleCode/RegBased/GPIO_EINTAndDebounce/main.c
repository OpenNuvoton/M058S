 ...
 * @return      None
 *
 * @details     The External INT0(P3.2) default IRQ, declared in startup_M058S.s.
 */
 ...
 * @return      None
 *
 * @details     The External INT1(P3.3) default IRQ, declared in startup_M058S.s.
 */
...
void SYS_Init(void)
{
    ...
    SYS->P3_MFP |= (SYS_MFP_P30_RXD | SYS_MFP_P31_TXD | SYS_MFP_P32_nINT0 | SYS_MFP_P33_nINT1);
