 ...
 * @brief
 *           Demonstrate A/D conversion with burst mode.
 *           In burst mode, ADC will sample and convert a specified channel continuously and store the conversion result in FIFO buffers.
 *
 * @note
